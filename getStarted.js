window.addEventListener("DOMContentLoaded", function(){
  ...
  let selectedDocs = []
  let doctorButtons = []
  let apprCode = Math.floor(Math.random()*100000+1)
  ...
  function renderDocs(docs){
    ...
    docs.forEach(doc => {
      futureDocs.innerHTML += `
      <div class="person">
        <a class="doctorName" href="https://appr.tc/r/${apprCode}"> ${doc.profile.first_name} ${doc.profile.last_name} </a>
    ...
    person.addEventListener("click", function(e){
      e.target.innerHTML += `
      <div class="chosenDoctor">
      <form action="https://appr.tc/r/123454">
    <input type="submit" value="Go to Doctor" />
</form>
